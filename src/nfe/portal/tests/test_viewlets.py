# -*- coding: utf-8 -*-
from nfe.portal.browser.viewlets.analytics import AnalyticsViewlet
from nfe.portal.browser.viewlets.logo import LogoViewlet
from nfe.portal.testing import INTEGRATION_TESTING
